...
sudamerica |> 
  ...
  geom_col(fill = "turquoise4") + #Color barras
...
#Si agregamos fill = pais en aes, nos da un grafico de arcoiris
...
ggplot(sudamerica, aes(anio, pib, color = pais)) +
  ...
  labs(title = "Comparación del PIB en Chile con el del resto de Sudamérica") +
  theme_bw()
